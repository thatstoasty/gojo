...
alias SplitFunction = fn (data: List[UInt8], at_eof: Bool) -> (
    Int,
    List[UInt8],
    Error,
)
...
###### split functions ######
fn scan_bytes(data: List[UInt8], at_eof: Bool) -> (Int, List[UInt8], Error):
...
fn drop_carriage_return(data: List[UInt8]) -> List[UInt8]:
...
fn scan_lines(data: List[UInt8], at_eof: Bool) -> (Int, List[UInt8], Error):
...
fn scan_words(data: List[UInt8], at_eof: Bool) -> (Int, List[UInt8], Error):
