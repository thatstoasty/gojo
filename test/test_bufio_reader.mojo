...
#     dest = List[UInt8, True](capacity=256)
#     _ = reader.read(dest)
...
# def test_read_slice():
#     reader = bufio.Reader(bytes.Buffer("0123456789"))
#     result = reader.read_slice(ord("5"))
#     print(result[0][0])
...
#     result = reader.read_bytes(ord("\n"))
#     testing.assert_equal(to_string(result[0]), "01234\n")


# def test_read_line():
#     reader = bufio.Reader(bytes.Buffer("01234\n56789"))
#     line: List[UInt8, True]
#     b: Bool
...
#     result = reader.peek(5)
#     testing.assert_equal(to_string(result[0]), "01234")
#     second_result = reader.peek(5)
#     testing.assert_equal(to_string(second_result[0]), "01234")


# def test_discard():
#     reader = bufio.Reader(bytes.Buffer("0123456789"))
#     result = reader.discard(5)
