...
struct Scanner[R: io.Reader, //, split: SplitFunction = scan_lines]():
    ...
    fn current_token_as_bytes(ref [_]self) -> Span[UInt8, __origin_of(self)]:
        """Returns the most recent token generated by a call to `Scanner.scan`."""
        return Span[UInt8, __origin_of(self)](unsafe_ptr=self.token.unsafe_ptr(), len=self.token.size)
